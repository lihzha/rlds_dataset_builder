    ...
    def _parse_hdf5_file(hdf5_path):
        ...
        with h5py.File(hdf5_path, "r") as f:
            ...
            for demo_name in demo_names:
                ...
                # arm_qpos = np.array(obs_group["arm_qpos"])  # shape (T, 7)
                    ...
                    episode.append(
                        {
                            ...
                            # "language_instruction": "Open the drawer and sweep all the objects into the drawer.",
                            # "language_instruction": "Place all the objects on the table using the box.",
                            # "language_instruction": "Place all the objects on the table using the box.",
                            "language_instruction": "Put the object in the shelf.",
                            # "language_instruction": np.array(language_instructions).item().decode(),
                        }
                    )
...
class PlanningQposDataset(MultiThreadedDatasetBuilder):
