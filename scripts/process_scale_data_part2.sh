...
#SBATCH --job-name=scale_part2    # Job name
#SBATCH --output=logs/%A_scale_part2.out   # Output file
#SBATCH --error=logs/%A_scale_part2.err    # Error file
...
# Build Part 2 (last ~3794 episodes, indices 3795-end)
python3 scripts/build_part2.py
