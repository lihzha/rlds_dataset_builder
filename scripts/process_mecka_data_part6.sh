...
#SBATCH --job-name=mecka_part6    # Job name
#SBATCH --output=logs/%A_mecka_part6.out   # Output file
#SBATCH --error=logs/%A_mecka_part6.err    # Error file
...
# Build Part 6 (~5,202 episodes, indices 31209-36410, ~39K samples)
python3 scripts/build_mecka_part6.py
