...
#SBATCH --job-name=mecka_part4    # Job name
#SBATCH --output=logs/%A_mecka_part4.out   # Output file
#SBATCH --error=logs/%A_mecka_part4.err    # Error file
...
# Build Part 4 (~5,202 episodes, indices 20806-26007, ~36K samples)
python3 scripts/build_mecka_part4.py
