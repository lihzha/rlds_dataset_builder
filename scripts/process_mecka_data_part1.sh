...
#SBATCH --job-name=mecka_part1    # Job name
#SBATCH --output=logs/%A_mecka_part1.out   # Output file
#SBATCH --error=logs/%A_mecka_part1.err    # Error file
...
# Build Part 1 (~10,403 episodes, indices 0-10402, ~37K samples)
python3 scripts/build_mecka_part1.py
