...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(zarr_path):
        ...
        try:
            ...
            # Determine sequence length from timestamps
        ...
        # Note: Pre-computed JSON segmentation files exist for only ~0.07% of episodes
        # (1 out of 1443 in data/aria). Not worth the complexity of checking for them.
        # The computation below is already optimal at O(n) and takes <1ms per episode.
...
class AriaDataset(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        base_dir = Path("/n/fs/robot-data/EgoVerse/data/aria")
        ...
        print(f"Each recording may contain multiple task instances (segmented by timestamps)")
