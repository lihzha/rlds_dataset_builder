...
from scale_dataset.conversion_utils import MultiThreadedDatasetBuilder
...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(zarr_path):
        ...
        # SCALE dataset uses dense language annotations for task segmentation
...
class ScaleDatasetBase(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        ...
        # Path to scale zarr data
        base_dir = Path("/n/fs/robot-data/EgoVerse/data/scale")
